...
<option value="" <c:if test="${magazine.category eq ''}">selected</c:if>></option>
<option value="NEWS" <c:if test="${magazine.category eq 'NEWS'}">selected</c:if>>뉴스</option>
<option value="STAR" <c:if test="${magazine.category eq 'STAR'}">selected</c:if>>스타</option>
</select> <br>
라벨
...
제목: <input type="text" id="title" name="title" value="${magazine.title }"> <br>
내용: <br><textarea rows="15" cols="30" id="content" name="content">${magazine.content }</textarea> <br>
<input type="hidden" value="${magazine.mgz_num }" name="mgz_num">
