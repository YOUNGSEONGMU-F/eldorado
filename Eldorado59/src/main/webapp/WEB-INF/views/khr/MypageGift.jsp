...
<div class="my_area">
    ...
    <div class="my_content lay_inner">
        ...
        <div class="my_resinfo_area">
            <ul class="tab_menu02">
                <li id="tabMenuOrder"><a href="${pageContext.request.contextPath}/Mypage">예매확인/취소</a></li>
             <!--  삭제  <li id="tabMenuPreticket" class="active"><a href="/MyPage/Index?tab=coupon">예매권/할인권 등록</a></li> -->
                <li id="tabMenuMovieGift" class="active"><a href="${pageContext.request.contextPath}/khr/MypageGift">무비기프트 구매내역</a></li>
            </ul>
             ...
             <div class="lyjReserveTable">
        		...
        		<table>
        		   <tr class="lyjTabletr">
	             	...
	             	<th class="lyjTabletd">티켓종류</th>
	             	<th class="lyjTabletd">수량</th>
	             	<th class="lyjTabletd">가격</th>
	             	<th class="lyjTabletd">취소하기</th>
	             	
	             </tr>
        		
        		
             <c:forEach items="${MovieGiftList}" var="list">
	         
             
             
               <tr class="lyjTabletr">
               	<td class="lyjcontentTd Bringreserve">${list.order_num}</td>
               	<td class="lyjcontentTd">${list.ticket_kinds}</td>
               	<td class="lyjcontentTd">${list.t_amount}</td>
               	<td class="lyjcontentTd">${list.price}</td>
